...
def process_paragraph_and_question(paragraph, question):
    prompt = f"""당신은 경제 전문가입니다. 다음 지문과 질문을 읽고, 질문에 답하기 위해 필요한 중요한 정보와 관련된 추가적인 경제적 맥락이나 배경 지식을 제공해주세요. 특히 지문에 언급된 경제 개념, 정책, 시장 동향, 기업 전략 등에 대해 더 자세한 설명이 필요할 경우 그 정보를 포함해주세요.
    ...
    <힌트>
    (지문의 내용과 질문을 바탕으로 중요한 경제적 정보와 추가적인 맥락을 제공해주세요. 답변은 간결하고 명확하게 300자 이내로 작성해주세요. 필요한 경우 관련 경제 이론, 통계 데이터, 또는 역사적 경제 사례를 포함할 수 있습니다.)
    """
...
# CSV 파일 처리 및 결과 저장
input_file = './raw_data/mmmlu_eco.csv'
output_file = './hint/mmmlu_eco_add_hint.csv'
